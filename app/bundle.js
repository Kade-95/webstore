...
const objectid_1 = require("../shared/objectid");
class LocalStorageDB {
    ...
    insertMany(docs) {
        ...
        for (let doc of docs)
            data.push(Object.assign(Object.assign({}, doc), { _id: objectid_1.generateId() }));
        this.setValue(data);
        return docs;
    }
    insertOne(doc) {
        const data = this.value;
        data.push(Object.assign({ _id: objectid_1.generateId() }, doc));
        this.setValue(data);
        return doc;
    }
    insert(doc) {
...
},{"../shared/objectid":3}],2:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
const localstorage_db_1 = require("./features/localstorage.db");
const db = new localstorage_db_1.LocalStorageDB('test');
console.log(db.delete({ age: 33 }));

},{"./features/localstorage.db":1}],3:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
